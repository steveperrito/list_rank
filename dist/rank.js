...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	  var tableArea = $('.appendClone'),
	      ...
	      myToDoList = new _ToDoList2.default(savedToDos),
	  ...
	  var sortable = _sortablejs2.default.create(tableArea[0], {
	    handle: '.handle',
	    animation: 0,
	    draggable: 'tr',
	    forceFallback: true,
	    onUpdate: function onUpdate() {
	      ...
	      myToDoList.sortByUID(sortOrder).save();
	  ...
	  clearCompletedLink.click(function (e) {
	    e.preventDefault();
	    myToDoList.clearCompleted().save();
	  ...
	  tableArea.click(function (e) {
	    ...
	    if (action.hasClass('rmvIt')) {
	      ...
	      myToDoList.remove(elementToDelete).sortByStatus().markFirstCompleted().save();
	    ...
	    if (action.hasClass('glyphicon-unchecked')) {
	      ...
	      myToDoList.complete(completedToDo).sortByStatus().markFirstCompleted().save();
	    ...
	    if (action.hasClass('glyphicon-check')) {
	      ...
	      myToDoList.notComplete(uncompletedToDo).sortByStatus().markFirstCompleted().save();
	    ...
	    if (action.hasClass('glyphicon-save')) {
	      ...
	      myToDoList.edit(toDoToUpdate, allEdits).save();
	  ...
	  function addToDo(newToDo, toDoInput, rankedClass) {
	    ...
	    myToDoList.add(newToDo).sortByStatus().markFirstCompleted().save();
	  ...
	  function sortColumn(btn, column, currentSortDirection, nextSortDirection) {
	    ...
	    myToDoList.sortIncompleteBy(column, nextSortDirection).markFirstCompleted().save();
...
/***/ function(module, exports, __webpack_require__) {
	...
	ToDoList.prototype.render = function (templateID) {
	  ...
	  return _mustache2.default.render(template, view);
	};
